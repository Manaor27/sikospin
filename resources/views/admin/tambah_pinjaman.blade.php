            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="simpan_pinjaman" class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Lama Angsuran</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Input Tempat Lahir" name="lama">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Denda telat bayar %</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Input Denda" name="denda">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
